...
for torrent in qbt_client.torrents_info():
    torrent_info = {
        ...
        "torrentFileName": f"{torrent.name}.torrent",  # Custom file name format, adjust as needed
        "torrentSaveLocation": torrent.save_path,
        "torrentsTags": torrent.tags.split(",") if torrent.tags else []  # Convert tags to list
    }
